...
public class Parking {
	...
	public synchronized String entrada1(int barrera, int id) throws Exception {
		s.acquire();
		return entrar(barrera, id, 1);
	}
	
	public synchronized String entrada2(int barrera, int id) throws Exception {
		s.acquire();
		return entrar(barrera, id,1 );
	}
	
	public synchronized String entrada3(int barrera, int id) throws Exception {
		s.acquire();
		return entrar(barrera, id, 1);
	}
	
	private String entrar(int barrera, int id, int entrada) throws Exception {
		...
		System.out.println("El coche " + id + " ha quedado bloqueado en la barrera " + barrera + " y la entrada numero " + entrada);
